...
Component* Battery::construct( std::string type, std::string id )
...
Battery::Battery( std::string type, std::string id )
       : Comp2Pin( type, id )
       , eResistor( id )
{
    ...
    addPropGroup( { "Main", {
new doubleProp<Battery>( "Voltage"   , "Voltage"   ,"V", this, &Battery::volt, &Battery::setVolt ),
new doubleProp<Battery>( "Resistance", "Resistance","Ω", this, &Battery::res,  &Battery::setRes ),
    },0 } );
}
Battery::~Battery() {}
