...
//     if( !m_memTable )
//     {
//         m_memTable = new MemTable(dataSize, wordBytes );
...
// bool MemData::loadData( std::vector<int>* toData, bool resize, int bits )
// {
...
// bool MemData::loadFile( std::vector<int>* toData, QString file, bool resize, int bits, eMcu* eMcu )
// {
//     m_eMcu = eMcu;
...
// bool MemData::loadDat( std::vector<int>* toData, QString file, bool resize )
// {
...
// bool MemData::loadHex( std::vector<int>* toData, QString file, bool resize, int bits )
// {
...
// bool MemData::loadBin( std::vector<int>* toData, QString fileName, bool resize, int bits )
// {
//     int bytes = (bits+7)/8;
//     int dataEnd = toData->size()-1;
...
// void MemData::saveData( std::vector<int>* data, int bits )
// {
//      Simulator::self()->pauseSim();
...
// void MemData::saveDat( std::vector<int>* data, int bits )
// {

// }

// void MemData::saveHex( std::vector<int>* data, int bits ) /// TODO
// {

// }

// void MemData::saveBin( std::vector<int>* data, int bits )
// {

// }

// QString MemData::getMem( std::vector<int>* data )
// {
//     QString m;
//     int size = data->size();
//     if( size > 0 )
...
// void MemData::setMem( std::vector<int>* data, QString m )
// {
//     if( m.isEmpty() ) return;
