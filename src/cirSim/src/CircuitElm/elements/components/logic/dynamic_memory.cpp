...
// Component* DynamicMemory::construct( std::string type, std::string id )
...
// DynamicMemory::DynamicMemory( std::string type, std::string id )
...
//     addPropGroup( { "Main", {
//         new intProp <DynamicMemory>("Row_Bits", "Row Address Size","_Bits", this
//                 , &DynamicMemory::rowAddrBits, &DynamicMemory::setRowAddrBits, propNoCopy,"uint" ),

//         new intProp <DynamicMemory>("Column_Bits", "Column Address Size","_Bits", this
//                 , &DynamicMemory::colAddrBits, &DynamicMemory::setColAddrBits, propNoCopy,"uint" ),

//         new intProp <DynamicMemory>("Data_Bits", "Data Size","_Bits", this
//                 , &DynamicMemory::dataBits, &DynamicMemory::setDataBits, propNoCopy,"uint" ),

//         new doubleProp<DynamicMemory>("Refresh", "Refresh period","ps", this
...
//     addPropGroup( { "Edges",IoComponent::edgeProps(),0 } );
// }
...
//     {
//         std::string number = std::string::number(i);
