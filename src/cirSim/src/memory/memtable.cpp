...
// MemTable::MemTable( int dataSize, int wordBytes )  //QWidget* parent, i
//         //: QWidget( parent )
// {
//     //setupUi(this);
...
// void MemTable::updateTable( std::vector<int>* data )
// {
...
// //    {
// //        std::string values = "Addr: 0x"+valToHex( address, m_addrBytes )
...
// void MemTable::setData( std::vector<int>* data, int wordBytes )
// {
//     m_data = data;
